...
var _ = Describe("Uroute53hostedzone Webhook", func() {
	var obj *Route53HostedZone

	BeforeEach(func() {
		obj = &Route53HostedZone{
			ObjectMeta: metav1.ObjectMeta{
				Name:      "test-route53hostedzone",
				Namespace: "default",
			},
	...
	Context("ValidateCreate", func() {
		It("should accept valid Uroute53hostedzone", func() {
