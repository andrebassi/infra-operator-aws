...
var _ = Describe("Uelasticachecluster Webhook", func() {
	var obj *ElastiCacheCluster

	BeforeEach(func() {
		obj = &ElastiCacheCluster{
			ObjectMeta: metav1.ObjectMeta{
				Name:      "test-elasticachecluster",
				Namespace: "default",
			},
			Spec: ElastiCacheClusterSpec{
	...
	Context("ValidateCreate", func() {
		It("should accept valid Uelasticachecluster", func() {
