...
var _ = Describe("Usecretsmanagersecret Webhook", func() {
	var obj *SecretsManagerSecret

	BeforeEach(func() {
		obj = &SecretsManagerSecret{
			ObjectMeta: metav1.ObjectMeta{
				Name:      "test-secretsmanagersecret",
				Namespace: "default",
			},
			Spec: SecretsManagerSecretSpec{
	...
	Context("ValidateCreate", func() {
		It("should accept valid Usecretsmanagersecret", func() {
