...
// +kubebuilder:webhook:path=/validate-aws-infra-operator-io-v1alpha1-routetable,mutating=false,failurePolicy=fail,sideEffects=None,groups=aws-infra-operator.runner.codes,resources=routetables,verbs=create;update,versions=v1alpha1,name=vroutetable.kb.io,admissionReviewVersions=v1

var _ webhook.Validator = &RouteTable{}

func (r *RouteTable) ValidateCreate() (admission.Warnings, error) {
	routetablelog.Info("validate create", "name", r.Name)
	return r.validateRouteTable()
}

func (r *RouteTable) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
	routetablelog.Info("validate update", "name", r.Name)
	return r.validateRouteTable()
}

func (r *RouteTable) ValidateDelete() (admission.Warnings, error) {
	routetablelog.Info("validate delete", "name", r.Name)
	return nil, nil
}

func (r *RouteTable) validateRouteTable() (admission.Warnings, error) {
