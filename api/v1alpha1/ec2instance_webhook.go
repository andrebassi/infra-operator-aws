...
// +kubebuilder:webhook:path=/validate-aws-infra-operator-io-v1alpha1-ec2instance,mutating=false,failurePolicy=fail,sideEffects=None,groups=aws-infra-operator.runner.codes,resources=ec2instances,verbs=create;update,versions=v1alpha1,name=vec2instance.kb.io,admissionReviewVersions=v1
...
func (r *EC2Instance) validateEC2Instance() (admission.Warnings, error) {
