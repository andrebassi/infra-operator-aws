...
1. **DNS Validation**: Prefer DNS over email for automation
2. **Wildcard**: Use for dynamic subdomains
3. **Regional**: Create certs in the region where they'll be used
4. **CloudFront**: Always use us-east-1 for CloudFront
5. **Monitoring**: Set up CloudWatch alarms for expiration
